...
function createCardFromData(title, content, gitLink, liveLink) {
  ...
  const liveLinkIcon = createIconElement(
    "icons",
    "imgs/icons/view.svg",
    "View icon",
    "view-icon",
  ...
  const gitLinkIcon = createIconElement(
    "icons",
    "imgs/icons/git.svg",
    "Git icon",
    "git-icon",
...
function attachCloseButtonClickEvent(
  card,
  closeButton,
  title,
  content,
